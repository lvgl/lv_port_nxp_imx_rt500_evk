...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_LAYER_SIMPLE_BUF_SIZE    (100 * 1024)   /*[bytes]*/
...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY  __attribute__ ((section (".SDRAMData,\"aw\",%nobits @")))
...
#define LV_DEMO_EBIKE_PORTRAIT		1

#define LV_USE_MATRIX 1

#define LV_DRAW_TRANSFORM_USE_MATRIX 1

#define LV_DRAW_THREAD_STACK_SIZE 65536

...
typedef struct {
  ...
  __IO uint32_t PINOUTDIS;                         /**< Pin Output Disable Register, offset: 0x68 */
  __IO uint32_t PINOUTCLR;                         /**< Pin Output Clear Register, offset: 0x6C */
  __IO uint32_t PINOUTSET;                         /**< Pin Output Set Register, offset: 0x70 */
  __IO uint32_t PINOUTTOG;                         /**< Pin Output Toggle Register, offset: 0x74 */

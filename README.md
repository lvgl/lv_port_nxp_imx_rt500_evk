# LVGL ported to NXP EVK-MIMXRT595

## Overview

This port is intended to use with the EVK-MIMXRT595, please use only the B revision since
...
* https://www.nxp.com/design/design-center/development-boards-and-designs/i-mx-evaluation-and-development-boards/i-mx-rt595-evaluation-kit:MIMXRT595-EVK
...
### CPU and Memory
- **MCU:** NXP IMXRT595 Cortex-M33 running up to 200 MHz
- **RAM:** 5MB of internal RAM, 8MB of external SDRAM
